...
export default function SixthSection() {
  ...
  const cardsData = [
    ...
    },
    {
      ...
      text: "Tulas International School is proud of its exquisite dining area. The food the school is served has been carefully planned with the assistance of a certified dietician to ensure that each day offers students an assortment of proteins, grains, fruits, and vegetables presented in delectable vegetarian dishes.",
    },
    {
      id: 7,
      image: management,
