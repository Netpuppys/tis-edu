...
function ParentsReviewsLanding() {
  const { isMobile } = useMobile();
  const [activeIndex, setActiveIndex] = useState(1); // Set default index to 1

  const testimonials = [
    "https://assets.tulas.edu.in/tis/landing1.mp4",
    "https://assets.tulas.edu.in/tis/landing2.mp4",
    "https://assets.tulas.edu.in/tis/landing3.mp4",
    "https://assets.tulas.edu.in/tis/landing4.mp4",
    "https://assets.tulas.edu.in/tis/landing5.mp4",
  ];
  ...
  const reviews = [
    ...
    "Our experience at Tulas International School has been outstanding. The nurturing environment and the attention given to each student’s individual progress have made a world of difference in our child's learning journey. The school's commitment to excellence is evident.",
    // "The caring approach of the teachers at Tulas has been instrumental in our child's development. Their personalized teaching methods have helped our child excel academically and socially. We couldn't be happier with the school's dedication to each student's success.",
  ];
    ...
    >
      ...
      <div className="relative w-full">
        <div className="w-full md:w-full mx-auto h-full flex items-center justify-center md:px-40 pt-8 md:pt-14 relative">
          ...
          /> */}
          <div className="w-[10%] h-full flex bg-transparent z-50 relative left-4 rotate-180">
  ...
  {testimonials.map((testimonial, index) => (
    <SwiperSlide key={index}>
      ...
      />
          ...
          <div className="w-[10%] h-full flex bg-transparent z-50 relative right-4">
...
export default ParentsReviewsLanding;
