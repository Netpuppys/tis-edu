      ...
      {!isMobile && (
        <>
          ...
          <button
            ...
            className="invisible see-all py-2 scale-90 hover:scale-100 transition-all ease-in duration-200 px-10 border-2 flex items-center justify-center uppercase text-[clamp(10px,4.5vw,30px)] md:text-[clamp(10px,1.3vw,45px)] leading-tight rounded-full text-[#5E5E5E] font-black font-[TTChocolatesBold] border-[#DBC79F]"
          >
            See All Awards{" "}
