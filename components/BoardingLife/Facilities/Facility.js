    ...
    <>
      ...
      <div className="py-8 md:py-14 w-[90%] md:w-[80%] mx-auto flex flex-wrap gap-4 justify-center">
        {cards.map((cards, index) => (
          ...
          >
            <div className="absolute z-10 bg-[#b90124] w-full h-full transition-all ease-in duration-500 translate-y-full group-hover:translate-y-0"></div>
            <div className="absolute z-20 transition-all ease-in duration-300 bottom-10 group-hover:top-10">
              ...
              <h3
                className="hidden group-hover:flex translate-y-full group-hover:translate-y-0 w-fit px-4 mx-auto text-[clamp(16px,1.2vw,50px)] text-white text-center"
                style={{
